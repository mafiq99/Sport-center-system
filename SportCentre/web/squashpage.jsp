    ...
    <body>
        <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
         ...
         <sql:query dataSource = "${snapshot}" var = "resultMon">
            SELECT * from monday WHERE type="Squash" ;
         </sql:query>
            
         <sql:query dataSource = "${snapshot}" var = "resultTue">
            SELECT * from tuesday WHERE type="Squash" ;
         </sql:query>
            
         <sql:query dataSource = "${snapshot}" var = "resultWed">
            SELECT * from wednesday WHERE type="Squash" ;
         </sql:query>
         
         <sql:query dataSource = "${snapshot}" var = "resultThu">
            SELECT * from thursday WHERE type="Squash" ;
         </sql:query>
            
         <sql:query dataSource = "${snapshot}" var = "resultFri">
            SELECT * from friday WHERE type="Squash" ;
         </sql:query>
            
         <sql:query dataSource = "${snapshot}" var = "resultSat">
            SELECT * from saturday WHERE type="Squash" ;
         </sql:query>
            
         <sql:query dataSource = "${snapshot}" var = "resultSun">
            SELECT * from sunday WHERE type="Squash" ;
         </sql:query>
                                        ...
                                        <tbody>
                                            <c:forEach var = "row" items = "${resultMon.rows}">
                                                <tr>
                                                   ...
                                                   <td><button id="1" onclick="window.location.href='squashpage.jsp'">Reserve</button></td>
                                                   </form>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
