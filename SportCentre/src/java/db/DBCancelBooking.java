 ...
 * @author 60192
 */
@WebServlet(name = "DBCancelBooking", urlPatterns = {"/DBCancelBooking"})
public class DBCancelBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PreparedStatement preparedStatement = jdbcUtility.psCancelBooking();           
            ...
            if (insertStatus == 1) {
                out.println("<script>");
                out.println("    alert('Boking Cancelled');");
